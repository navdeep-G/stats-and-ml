...
#(Simple Monte Carlo integration, cont.)
...
#(Monte Carlo integration, unbounded interval)
...
#(MC integration using control variates)
...
#(Control variate and regression)
...
#(Choice of the importance function)
    ...
    #(Choice of the importance function)
    #code for plot is at the end of the file continued...

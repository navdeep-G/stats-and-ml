...
#(Derivative of zeta function, cont.)
...
#(Solving f(x)=0 with Brent's method: uniroot)
...
#(Density of sample correlation coefficient)
...
# (Two-dimensional optimization with optim)

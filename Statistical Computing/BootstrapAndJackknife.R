...
#(Bootstrap confidence intervals for patch ratio statistic)
...
#(Bootstrap confidence intervals for the correlation statistic)
...
#(BCa bootstrap confidence interval using boot.ci)

...
#(Histogram density estimates using Sturges' Rule)
...
#(Density estimates from a histogram)

    #using histograms from Example 10.1
    x0 <- .1
...
#(Density estimation for Old Faithful)
...
#(KDE of Old Faithful waiting time)
...
#(Computing $\hat f(x)$ for arbitrary x)
...
#(Product kernel estimate of a BVN mixture)
